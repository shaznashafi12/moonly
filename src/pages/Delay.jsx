...
function Delay() {
  ...
  const handleCheckDelay = () => {
    ...
    if (delay <= 0) {
      resultMessage = "Your cycle is on track!";
    } 
    else if (delay > 0 && delay <= 10) {
  doctorAdvice =
    "A delay of less than 5 days is usually normal. There is generally no need to worry unless symptoms are unusual or persistent.";
}
    else if (delay > 10 && delay <= 15) {
      resultMessage = `Your period is ${delay} day${delay > 1 ? "s" : ""} late`;
      reasonsArray = [
      ...
      doctorAdvice = "It is recommended to consult a doctor if the delay continues.";
    }
    else {
      ...
      doctorAdvice = "Please consult a healthcare professional immediately.";
    }
