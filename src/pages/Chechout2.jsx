...
if (!shipping.state.trim()) {
  ...
  try {
    ...
    // clear pregnancy cart
    localStorage.removeItem("cart_pregnancy");
          ...
          <div className="bg-white rounded-2xl shadow p-6 space-y-4">
            ...
            <div className="pt-4 space-y-3">
              ...
              <button
                ...
                disabled={loading}
                className="w-full mt-3 bg-[#051a2f] text-white py-3 rounded-xl font-medium hover:scale-[1.03] transition"
              >
